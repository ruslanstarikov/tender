        ...
        function renderSelectedWindows() {
            ...
            container.innerHTML = selectedWindows.map(window => `
                <div class="window-item border rounded-lg p-6">
                    ...
                    <input type="hidden" name="windows[${window.id}][template_id]" value="${window.template_id}">
                    <input type="hidden" name="windows[${window.id}][label]" value="${window.label}">
                    <input type="hidden" name="windows[${window.id}][width_mm]" value="${window.width_mm}">
                    <input type="hidden" name="windows[${window.id}][height_mm]" value="${window.height_mm}">
