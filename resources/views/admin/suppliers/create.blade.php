    ...
    <div class="mb-8">
        ...
        <div class="flex items-center gap-4">
            <div class="p-3 bg-primary/10 rounded-lg">
                <i class="iconoir-truck text-2xl text-primary"></i>
            </div>
            <div>
                <h1 class="text-3xl font-bold text-base-content">Add New Supplier</h1>
                <p class="text-base-content/60 mt-1">Create a new window frame supplier account</p>
            </div>
        </div>
    </div>

    <form method="POST" action="{{ route('admin.suppliers.store') }}" enctype="multipart/form-data" class="space-y-8">
        @csrf
        ...
        <div class="card bg-base-100 shadow-lg">
            <div class="card-body p-8">
                ...
                <div class="form-control w-full mt-8">
                    ...
                    <label class="label pt-2">
                        <span class="label-text-alt text-base-content/60">Upload PNG, JPG, or GIF. Maximum file size: 2MB</span>
                    </label>
                    @error('logo')
                ...
                <div class="form-control w-full mt-8">
                    ...
                    <textarea name="company_description" 
                              ...
                              class="textarea textarea-bordered textarea-lg w-full @error('company_description') textarea-error @enderror">{{ old('company_description') }}</textarea>
            ...
            <div class="card-body p-8">
                ...
                <div class="form-control w-full mt-8">
                    ...
                    <textarea name="certifications" 
                              ...
                              class="textarea textarea-bordered textarea-lg w-full @error('certifications') textarea-error @enderror">{{ old('certifications') }}</textarea>
            ...
            <div class="card-body p-8">
                <div class="flex items-center gap-3 mb-6">
                    <div class="p-2 bg-error/10 rounded-lg">
                        <i class="iconoir-lock text-xl text-error"></i>
                    </div>
                    <h2 class="text-2xl font-semibold">Login Credentials & Status</h2>
                </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                    ...
                    <div class="form-control w-full">
                        <label class="label pb-2">
                            <span class="label-text font-medium text-base">Password <span class="text-error">*</span></span>
                        </label>
                        <input type="password" 
                               name="password" 
                    ...
                    <div class="form-control w-full">
                        <label class="label pb-2">
                            <span class="label-text font-medium text-base">Confirm Password <span class="text-error">*</span></span>
                        </label>
                        <input type="password" 
                ...
                <div class="form-control w-full">
                    ...
                    <textarea name="admin_notes" 
                              ...
                              class="textarea textarea-bordered textarea-lg w-full @error('admin_notes') textarea-error @enderror">{{ old('admin_notes') }}</textarea>
                    @error('admin_notes')
                        <label class="label pt-2">
                            <span class="label-text-alt text-error font-medium">{{ $message }}</span>
                        </label>
        ...
        <div class="flex justify-end gap-4 pb-8">
            <a href="{{ route('admin.suppliers.index') }}" class="btn btn-outline btn-lg px-8">
